# Developer Quick Start (moved from root README)

This guide contains the original developer-focused content that previously lived in the root `README.md`.

If you're looking for **how to play the game**, see the root `README.md`.
